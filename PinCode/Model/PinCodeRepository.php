...
use NewTask\PinCode\Model\PinCodeFactory;
use NewTask\PinCode\Model\ResourceModel\PinCode as ObjectResourceModel;
...
class PinCodeRepository implements PinCodeRepositoryInterface
{
     ...
     *
     * @param PinCodeFactory $objectFactory
     * @param ObjectResourceModel $objectResourceModel
     * @param CollectionFactory $collectionFactory
     * @param SearchResultsInterfaceFactory $searchResultsFactory
     */
    public function __construct(
        PinCodeFactory $objectFactory,
     ...
     */
    public function save(PinCodeInterface $object)
    {
        try {
     ...
     * @inheritDoc
     */
    public function delete(PinCodeInterface $object)
    {
        try {
